...
namespace Octophp\Encore\Route\Strategy;
...
class JsonStrategy extends AbstractStrategy implements StrategyInterface, ContainerAwareInterface, OptionsHandlerInterface
{
